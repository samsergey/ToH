...
const MG1 = (l,g) => new GG1(Exponential(l),g)
const MM1 = (l,m) => new GG1(Exponential(l),Exponential(m))
const DD1 = (l,m) => new GG1(DeltaDistribution(1/l),DeltaDistribution(1/m))
const MD1 = (l,m) => new GG1(Exponential(l),DeltaDistribution(1/m))
const DM1 = (l,m) => new GG1(DeltaDistribution(1/l),Exponential(m))
