...
function Graphics(viewport, opts)
{
    ...
    this.width = this.viewportWidth - this.options.margin_left - this.options.margin_right
    this.height = this.viewportHeight - this.options.margin_top - this.options.margin_bottom    
    this.paper.attr('width',this.width)
	.attr('height',this.height)
	.attr('transform','translate('+this.options.margin_left+','+this.options.margin_top+')')
...
Graphics.prototype.clipPaper = function ()
{
	...
	.attr("x", 0)
	.attr("y", 0)
	.attr("width", this.options.margin_left)
	...
	.attr("height", this.options.margin_top)
	.attr("class", 'clip')
    this.viewport.append("rect")
	.attr("x", 0)
	.attr("y", this.viewportHeight-this.options.margin_bottom)
	.attr("width", this.viewportWidth)
	.attr("height", this.options.margin_bottom)
	.attr("class", 'clip')
    this.viewport.append("rect")
	.attr("x", this.viewportWidth-this.options.margin_right)
	.attr("y", 0)
	.attr("height", this.viewportHeight)
	.attr("width", this.options.margin_right)
	.attr("class", 'clip')
    return this
}
...
Graphics.prototype.axes = function (opts)
{
    ...
    var xAxisPositionX = this.options.margin_left
    var xAxisPositionY = this.viewportHeight - this.options.margin_bottom+1
    var yAxisPositionX = this.options.margin_left-1
    var yAxisPositionY = this.options.margin_top
    var xAxisLabelPositionX = this.options.margin_left + this.width / 2 + 0
    var xAxisLabelPositionY = this.viewportHeight - this.options.margin_bottom / 3
    var yAxisLabelPositionX = 12 + 0*this.options.margin_left
    var yAxisLabelPositionY = this.options.margin_top + this.height / 2 -20
	...
	g.append('g').attr('class','axisLabel')
	    ...
	    .attr('dx',-options.xLabel.length*2)
	    .text(options.xLabel)
	...
	g.append('g').attr('class', 'axisLabel')
	    ...
	    .append("text").attr('class', options['class'])
	    .attr('dx', -options.yLabel.length*3)
