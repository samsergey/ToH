...
{
    var defaults = {
	margin    : {left : 40, right : 30, top : 30, bottom : 55}, 
	xRange    : 'automatic',
	yRange    : 'automatic',
	xAxisType : 'linear',
	yAxisType : 'linear',
...
Graphics.prototype.axes = function (opts)
{
    ...
    var xAxisLabelPositionX = this.options.margin.left + this.width / 2 + 0
    ...
    var yAxisLabelPositionY = this.options.margin.top + this.height / 2 -20
