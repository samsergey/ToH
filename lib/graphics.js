...
Graphics.prototype.axes = function (opts)
{
    ...
    var xAxisLabelPositionY = this.viewportHeight - this.options['bottom-margin'] / 3
    var yAxisLabelPositionX = 12 + 0*this.options['left-margin']
